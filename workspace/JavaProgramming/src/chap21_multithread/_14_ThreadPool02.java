...
public class _14_ThreadPool02 {
	...
	public static void main(String[] args) {
		...
		// Thread에 boolean 값을 통해 shutdown() 메소드가 호출돼도
		// 바로 스레드 풀을 종료시킬 수 있다.
		...
		// 주 스레드가 종료돼도 남아있는 작업들이 계속해서 진행된다.
		// 이러한 문제를 방지하고자 주 스ㅔㄹ드가 종료되기 전에
		...
		// shutdown() 메소드가 호출됐을 스레드에 알리고 스레드가 안전하게 종료될 수 있도록 한다.
		threadPool.shutdown();
		pt.setShutdown(true);
	}
