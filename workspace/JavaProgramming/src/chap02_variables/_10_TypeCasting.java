...
public class _10_TypeCasting {
	...
	public static void main(String[] args) {
		...
		// 1. 자동형변환1: byte 크기가 작읍 타입에서 큰 타입으로는 자동형변환이 일어난다.
		short sNum1 = 10;
		
		//short은 2byte고 int는 4byte이기 때문에 sNum1d이 자동으로 int 타입으로 변환된다.
		int iNum1 = sNum1;
		...
		// 5. 연산에서의 형변환
		// 형변환순서에 따라서 연산중에 byte 크기가 더 큰 타입이나 좀 더 세밀한 표현범위를 갖는 타입으로 자동 현변환이 일어난다.
